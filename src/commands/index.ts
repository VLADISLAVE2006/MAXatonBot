...
import { handleHubMyEventsCallback, handleCancelRegistrationCallback, handleEventStatsCallback, handleQrCallback, handleCloseEventCallback } from "./my_events";
...
export function collectCommandCallbackHandlers(): CallbackHandler[] {
    return [handleMenuCallback, handleHubEventsCallback, handleRegisterCallback, handleHubMyEventsCallback, handleCancelRegistrationCallback, handleEventStatsCallback, handleQrCallback, handleCloseEventCallback, handleHubNotificationsCallback];
}
